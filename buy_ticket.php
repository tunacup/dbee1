        ...
        <div class="col-lg-3 col-md-6 p-3">
          <div class="card bg-light text-center">
            <div class="card-body p-4">
              ...
              <h2><b>4500 ฿</b></h2>
              <hr>
              <a class="btn btn-primary" href="blankA1.php">BUY</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 p-3">
          <div class="card bg-light text-center">
            <div class="card-body p-4">
              ...
              <h2> <b>4500 ฿</b></h2>
              <hr>
              <a class="btn btn-primary" href="blankA2.php">BUY</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 p-3">
          <div class="card bg-light text-center">
            <div class="card-body p-4" style="">
              <h3>B STANDING</h3>
              <h2> <b>3500 ฿</b></h2>
              <hr><a class="btn btn-primary" href="blankB.php">BUY</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 p-3">
          <div class="card bg-light text-center">
            <div class="card-body p-4">
              ...
              <h2> <b>2500 ฿</b></h2>
              <hr>
              <a class="btn btn-primary" href="blankC.php">BUY</a>
            </div>
          </div>
        </div>
      </div>
